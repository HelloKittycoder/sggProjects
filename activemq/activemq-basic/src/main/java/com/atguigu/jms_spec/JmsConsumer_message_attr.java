 ...
 * @date 2022/6/23 5:45
 */
public class JmsConsumer_message_attr {

    public static final Logger LOGGER = LoggerFactory.getLogger(JmsConsumer_message_attr.class);
    public static final String ACTIVEMQ_URL = "tcp://192.168.21.134:61616";
    public static final String QUEUE_NAME = "jms_queue_attr";
