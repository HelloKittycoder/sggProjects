...
/**
 * 定义Tag过滤Consumer
 * 说明：该主题下实际只是消费了那些符合过滤条件的消息，但是实际上，就算消息不符合条件，该消息也是被消费状态
 * 符合过滤条件的（Consumed）、不符合过滤条件的（Consumed but filtered）
 *
 * 注意：
...
public class FilterByTagConsumer {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(FilterByTagConsumer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        consumer.subscribe("filterTagTopic", "myTagA || myTagB");
